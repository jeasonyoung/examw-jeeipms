...
<t:datagrid name="functionList" title="菜单管理" actionUrl="sysfunctionController.do?functionGrid" idField="id" treegrid="true" pagination="false">
 ...
 <t:dgDelOpt url="sysfunctionController.do?del&id={id}" title="删除"></t:dgDelOpt>
 ...
 <t:dgToolBar title="菜单录入" icon="icon-add" url="sysfunctionController.do?addorupdate" funname="add"></t:dgToolBar>
 <t:dgToolBar title="菜单编辑" icon="icon-edit" url="sysfunctionController.do?addorupdate" funname="update"></t:dgToolBar>
</t:datagrid>
</div>
...
{
	$('#operationDetailpanel').panel("refresh", "sysfunctionController.do?operation&functionId=" +functionId);
}
</script>
<%--   update-end--Author:anchao  Date:20130415 for：按钮权限控制--%>
