...
<t:datagrid name="operationList" title="操作管理" actionUrl="sysfunctionController.do?opdategrid&functionId=${functionId}" idField="id">
 ...
 <t:dgDelOpt url="sysfunctionController.do?delop&id={id}" title="删除"></t:dgDelOpt>
 <t:dgFunOpt funname="editoperation(id,operationname)" title="编辑"></t:dgFunOpt>
 <t:dgToolBar title="操作录入" icon="icon-add" url="sysfunctionController.do?addorupdateop&functionId=${functionId}" funname="add"></t:dgToolBar>
...
{
	createwindow("操作编辑","sysfunctionController.do?addorupdateop&functionId=${functionId}&id="+operationId);
}
</script>
