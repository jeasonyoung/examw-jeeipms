...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="sysorderController.do?save">
			...
			<td class="value">
				<input nullmsg="请填写学员" errormsg="学员格式不对" class="inputxt" id="stuId" name="stuId" 
									   value="${orderPage.stuId}" datatype="*">
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			...
			<td class="value">
				<input nullmsg="请填写备注" errormsg="备注格式不对" class="inputxt" id="orderContent" name="orderContent" ignore="ignore"
									   value="${orderPage.orderContent}">
								<span class="Validform_checktip"></span>
			</td>
			<td align="right"><label class="Validform_label">修改人:</label></td>
			<td class="value">
				<input nullmsg="请填写修改人" errormsg="修改人格式不对" class="inputxt" id="modifier" name="modifier" ignore="ignore"
									   value="${orderPage.modifier}">
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			<td align="right"><label class="Validform_label">修改人名字:</label></td>
			<td class="value">
				<input nullmsg="请填写修改人名字" errormsg="修改人名字格式不对" class="inputxt" id="modifierName" name="modifierName" ignore="ignore"
									   value="${orderPage.modifierName}">
								<span class="Validform_checktip"></span>
			</td>
			<td align="right"><label class="Validform_label">修改时间:</label></td>
			<td class="value">
				<input nullmsg="请填写修改时间" errormsg="修改时间格式不对" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="modifyDt" name="modifyDt" ignore="ignore"
									     value="<fmt:formatDate value='${orderPage.modifyDt}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>">
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			<td align="right"><label class="Validform_label">删除标记:</label></td>
			<td class="value">
				<input nullmsg="请填写删除标记" errormsg="删除标记格式不对" class="inputxt" id="delflag" name="delflag" ignore="ignore"
									   value="${orderPage.delflag}" datatype="n">
								<span class="Validform_checktip"></span>
			</td>
			<td align="right"><label class="Validform_label">删除时间:</label></td>
			<td class="value">
				<input nullmsg="请填写删除时间" errormsg="删除时间格式不对" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="delDt" name="delDt" ignore="ignore"
									     value="<fmt:formatDate value='${orderPage.delDt}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>">
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			</table>
