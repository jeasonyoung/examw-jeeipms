...
<div class="easyui-layout" fit="true" >
 <div region="center" style="padding: 1px;">
  <t:datagrid name="roleList" title="角色列表" actionUrl="sysroleController.do?roleGrid" idField="id">
   ...
   <t:dgToolBar title="角色录入" icon="icon-add" url="sysroleController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="角色编辑" icon="icon-edit" url="sysroleController.do?addorupdate" funname="update"></t:dgToolBar>
  </t:datagrid>
 </div>
...
function setfunbyrole(id,roleName) {
	...
	$('#function-panel').panel("refresh", "sysroleController.do?fun&roleId=" + id);
...
function delRole(id){
	...
	var url= 'sysroleController.do?delRole&id='+id;
