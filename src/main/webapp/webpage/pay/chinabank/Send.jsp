...
String v_mid,key,v_url,v_oid,v_amount,v_moneytype,v_md5info;  //定义必须传递的参数变量
	...
	key = "2dsfa9023Dfsd00vmba562";									      // 如果您还没有设置MD5密钥请登陆我们为您提供商户后台，地址：https://merchant3.chinabank.com.cn/
													      ...
													      // 建议您设置一个16位以上的密钥或更高，密钥最多64位，但设置16位已经足
	String remark2 = "[url:="+Globals.getConfig("domain")+"/orderController.do?chinaBankAuto&encoding=UTF-8]";
//**********************************************
//以上三项必须修改		
	  if(request.getParameter("orderNo")!=null && !request.getParameter("orderNo").equals(""))  //判断是否有传递订单号
	  {
		  v_oid=request.getParameter("orderNo");
	  }
		else                         
	  {
