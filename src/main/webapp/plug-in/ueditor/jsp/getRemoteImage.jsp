    ...
    <%
    	...
    	String realpath = rootpath+"/userfiles/"+request.getSession().getAttribute("agengcyid")+"/"+filePath;
    	...
    	for(int i=0;i<arr.length;i++){
    		...
    		outSrc[i]="/userfiles/"+request.getSession().getAttribute("agengcyid")+"/"+filePath+"/"+ saveName;
    		try {
