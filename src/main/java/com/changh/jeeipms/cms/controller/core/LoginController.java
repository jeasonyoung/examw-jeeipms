...
import com.changh.jeeipms.cms.entity.base.TSConfig;
import com.changh.jeeipms.cms.entity.base.TSFunction;
import com.changh.jeeipms.cms.entity.base.TSRole;
...
import com.changh.jeeipms.cms.entity.base.TSVersion;
...
public class LoginController {
	...
	public ModelAndView pwdInit(HttpServletRequest request) {
		...
		user.setUserName(Globals.getConfig("adminUsername"));
		userService.pwdInit(user,Globals.getConfig("adminPassword"));
		...
		//update-end--Author:chenxu  Date:20130322 for：左侧菜单信息放入到session中
			...
			if (loginActionlist.size() > 0) {
				for (TSFunction function : loginActionlist) {
					//System.out.println(function.getFunctionLevel());
