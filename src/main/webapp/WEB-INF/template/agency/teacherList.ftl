...
<!--主体部分-->
<div class="content">
<div class="location">您现在所在的位置：<a href="index.html">${agency.name}</a>>><a href="#">老师列表</a></div>
<!--左-->
<div class="jgLeft">
...
<div class="jgRight">
<div class="jgboxr">
<div class="jgtitl"><div class="Hleft nob"><a href="#">师资介绍</a></div></div>
<ul class="teac">
<#list teacherList as teacher>
<li>
<div class="pic"><a href="teacher_${teacher.id}.html"><img src="${teacher.imageurl?default("../img/teacherdefault.jpg")}"></a></div>
<div class="txt"><a href="teacher_${teacher.id}.html" class="name">${teacher.realname}</a><a href="teacher_${teacher.id}.html" class="xix">详细介绍</a></div>
</li>
</#list>
</ul>
<div class="clear"></div>
