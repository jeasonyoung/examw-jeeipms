...
public class AuthInterceptor implements HandlerInterceptor {
	...
	private List<String> excluderController;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		if (excludeUrls.contains(requestPath)||this.getExcluderController().contains(names[0])) {
			return true;
		} else {
	...
	public  List<String> getExcluderController() {
		PropertiesUtil p = new PropertiesUtil("sysConfig.properties");
		String[] s =p.readProperty("excluderController").split(",");
