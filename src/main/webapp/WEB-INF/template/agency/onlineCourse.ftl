...
<!--主体部分-->
<div class="content">
<div class="location">您现在所在的位置：<a href="index.html">${course.agency.name}</a>>><a href="onlineCourse.html">视频课程</a>>><a href="#">${course.coursename}</a></div>
<!--左-->
<div class="jgLeft">
...
<div class="shipRbox">
<div class="spBox">
<h1>￥${course.favorableprice}</h1>
<h3>主讲老师：<span>${course.teacher.realname?default("暂无介绍")}</span></h3>
<div class="bttn"><a href="${domain}/cartController.do?cartList&courseId=${course.id}">立即购买</a></div>
<div class="blk10"></div>
</div>
...
<div class="p1"><div class="fz">请评论：</div><textarea id="content" name="" cols="" rows="" class="kuang"></textarea></div>
<div class="anniu" onclick="return AddComment();"><a href="javascript:;"></a></div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#left_course").load("left_facelist.html");
 ...
 function test(){
	   thePlayer =   jwplayer("player").setup({
		    flashplayer: hostname+'/plug-in/player/examw.swf',			   
          	...
          	'file': "http://www.youeclass.com:8090/youe2014ejjjjzst.flv" ,
			controlbar: 'bottom',
			height:300,
			width:530,
			stretching:'fill',
