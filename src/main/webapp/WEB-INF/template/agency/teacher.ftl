...
<link href="${domain}/agency/img/page.css" rel="stylesheet" type="text/css" />
...
<!--主体部分-->
<div class="content">
<div class="location">您现在所在的位置：<a href="index.html">${agency.name}</a>>><a href="teacherList.html">老师列表</a>>><a href="#">${teacher.realname}</a></div>
<!--左-->
<div class="jgLeft">
...
<div class="blk10"></div>
<div class="jgboxl">
<div class="jgtitl"><div class="Hleft"><a href="#">名师排行</a></div><div class="amore"><a href="#">更多>></a></div></div>
</div>
</div>
<!--右-->
<div class="jgRight">
<div class="jgboxr">
<div class="jgtitl"><div class="Hleft nob"><a href="#">师资介绍</a></div><div class="amore"><a href="#">更多>></a></div></div>

<div class="boxSx">
<div class="infor">
<div class="j_name"><div class="h03">${teacher.realname}</div></div>
<div class="blk10"></div>
<div class="d_pic">
<img src="${teacher.imageurl?default("../img/teacherdefault")}">
</div>
<div class="d_txt">
<ul>
<li><b>主要课程</b>：${teacher.lessons}</li>
<li><b>名师介绍</b>：<br />
${teacher.description}
<br />
</li>
...
<div class="blk10"></div>
<div class="titleSx">
<div class="btn1" id="sj_1" onMouseOver="switchTag('sj_','sj_list',1,2,'btn1','btn2');"><a href="#">推荐课程</a></div>
<div class="btn2" id="sj_2" onMouseOver="switchTag('sj_','sj_list',2,2,'btn1','btn2');"><a href="#">学员评价</a></div>
</div>
...
<li>
<div class="jgimg">
<div class="igimg1"><img src="${domain}${hot.imageurl?default("/agency/img/jg1.jpg")}" /></div>
...
<script type="text/javascript">
 ...
 var courseid ="${teacher.id}",pagesize=6;
