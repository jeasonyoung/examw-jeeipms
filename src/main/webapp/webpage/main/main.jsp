...
a:hover {
 ...
 <body class="easyui-layout" style="overflow-y: hidden" scroll="no">
  <!-- 顶部-->
  <div region="north" border="false" title="畅亨信息综合学习平台" style="BACKGROUND:#E6E6FA;height: 85px; padding: 1px; overflow: hidden;">
      ...
      <table>
       ...
       <td>
        ...
        <div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
         <div onclick="openwindow('用户信息','sysuserController.do?userinfo')">
          个人信息
         </div>
         <div class="menu-sep"></div>
         <div onclick="add('修改密码','sysuserController.do?changepassword')">
          修改密码
         </div>
        </div>
  ...
  <div region="south" border="false" style="height: 25px; overflow: hidden;">
    ...
    &copy; 版权所有
     <span class="tip"><a href="http://www.examw.com" title="畅亨信息技术有限责任公司">畅亨信息</a> (推荐谷歌浏览器，获得更快响应速度)  技术支持:<a href="#" title="畅亨信息技术有限责任公司">畅亨信息</a></span>
   </div>
  </div>
