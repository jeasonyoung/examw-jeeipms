...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sysuserController.do?saveUser">
   ...
   <table style="width:600px;" cellpadding="0" cellspacing="1" class="formtable">
    <tr>
     ...
     ${user.userName }
      ...
      <c:if test="${user.id==null }">
       <input id="userName" class="inputxt" name="userName" ajaxurl="sysuserController.do?checkUser&code=${user.userName }" value="${user.userName }" datatype="s2-10" >
    ...
    <tr>
     ...
     <td class="value" nowrap>
      ...
      <t:choose hiddenName="roleid" hiddenid="id" url="sysuserController.do?roles" name="roleList" icon="icon-choose" title="角色列表" textname="roleName" isclear="true"></t:choose>
