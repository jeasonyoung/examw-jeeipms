...
public class CommonServiceImpl implements CommonService {
	...
	public <T> List<T> getList(Class<?> clas) {
		return commonDao.loadAll((Class<T>)clas);
	}
	...
	//@Override
	public List<ComboTree> courseCategoryTree(List<CourseCategoryEntity> all,
			org.jeecgframework.core.common.model.json.ComboTree comboTree) {
		return commonDao.courseCategoryTree(all, comboTree);
	}
	/**
	 * 根据模型生成JSON
	 * 
	...
	public <T> List<T> findHql(String hql, int page, int rows, Object... param) {
		...
		return this.commonDao.findHql(hql, page, rows, param);
	}
	...
	public <T> List<T> getListByOrder(Class<T> entityClass,String propertyName,Object value, String ordername, boolean isAsc,String method) {
		// TODO Auto-generated method stub
		return this.commonDao.getListByOrder(entityClass, propertyName, value, ordername, isAsc, method);
	}
